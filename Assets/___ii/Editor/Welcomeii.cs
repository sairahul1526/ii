...
{
	[InitializeOnLoad]
	public class Welcomeii : EditorWindow 
	{
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		private const string ONLINE_DOC_URL = "https://docs.google.com/document/d/1FGFaPYO1XVEvQxka0tf6ZolC0WhrWNcGFgjDIemsSAc/edit?usp=sharing";
		private const string RATEUS_URL = "http://u3d.as/w2L";

		private const string NAME_OF_THE_GAME = "ii";
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
		/******* TO MODIFY **********/
